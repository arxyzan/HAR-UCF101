...
def get_train_test_lists(version='01'):
    ...
    test_file = os.path.join('data/ucfTrainTestlist', 'testlist' + version + '.txt')
    train_file = os.path.join('data/ucfTrainTestlist', 'trainlist' + version + '.txt')
...
def move_files(file_groups, data_dir='data/videos/'):
